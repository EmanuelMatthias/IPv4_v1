...
import { SubnettingOverview } from './pages/subnetting-overview/subnetting-overview';
import { SubnettingExercise } from './pages/subnetting-exercise/subnetting-exercise';
...
export const routes: Routes = [
    ...
    { path: 'subnetting-overview', component: SubnettingOverview },
    { path: 'subnetting-exercise', component: SubnettingExercise },
